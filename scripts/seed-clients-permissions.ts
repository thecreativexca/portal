/**
 * Idempotent permission sync for the Clients / Invoices module.
 *
 * For every company it:
 *  1. Inserts any missing Permission documents from the catalog (this adds
 *     clients.read / clients.write / invoices.read / invoices.write to
 *     existing deployments without wiping anything).
 ...
 *
 * Run: npx ts-node scripts/seed-clients-permissions.ts
 */

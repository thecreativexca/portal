/**
 * Idempotent permission sync for the Day 9 modules (notifications, approvals,
 * documents). For every company it:
 *  1. Inserts any missing Permission documents from the catalog (adds
 *     notifications.read / approvals.read / approvals.approve / documents.read /
 *     documents.write to existing deployments without wiping anything).
 ...
 *
 * Run: npx ts-node scripts/seed-day9-permissions.ts
 */

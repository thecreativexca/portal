/**
 * Idempotent permission sync for the Finance module.
 *
 * For every company it:
 *  1. Inserts any missing Permission documents from the catalog (this adds
 *     expenses.read / expenses.write / payroll.read / payroll.write /
 *     finance.read to existing deployments without wiping anything).
 ...
 *
 * Run: npx ts-node scripts/seed-finance-permissions.ts
 */
